source("twitterSpainMap.R")
busqueda="vox_es"
file=paste(busqueda,"_twitterMap.pdf",sep="")
twitterMap(busqueda,userLocation="Madrid,Spain",fileName=file,  nMax=1500,plotType="followers")
...
chennai <-  geocode("Spain")  # get longitude and latitude
...
# Google Road Map
chennai_ggl_road_map <- qmap("Spain", zoom=12, source = "google", maptype="roadmap")  
