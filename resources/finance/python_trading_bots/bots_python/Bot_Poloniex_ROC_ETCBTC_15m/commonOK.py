...
def zs(arr,LRp,FL,STDp):
    valor=(arr-talib.LINEARREG(arr,LRp)+FL*talib.LINEARREG_SLOPE(arr,LRp))/talib.STDDEV(arr,STDp)
    return valor
...
# zf4(CK,A1,LRp1,FL1,STDp1,B1,LRp2,FL2,STDp2,C1,LRp3,FL3,STDp3,D1,LRp4,FL4,STDp4):
#    valor=A1*zs(CK, LRp1, FL1, STDp1)+B1*zs(CK, LRp2, FL2, STDp2)+C1*zs(CK, LRp3, FL3, STDp3) +D1*zs(CK, LRp4, FL4, STDp4)
