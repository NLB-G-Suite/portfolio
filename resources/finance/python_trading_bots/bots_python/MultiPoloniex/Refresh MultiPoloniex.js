...
/*
	...
	**#}
*/	
//C:\AmiBroker\Formulas\CSV_Tickers\PO-BTC_AMP-5m.csv
	Import("C:\\AmiBroker\\Formulas\\CSV_Tickers\\PO-BTC_AMP-5m.csv");
	Import("C:\\AmiBroker\\Formulas\\CSV_Tickers\\PO-BTC_DASH-5m.csv");
	Import("C:\\AmiBroker\\Formulas\\CSV_Tickers\\PO-BTC_ETC-5m.csv");
	Import("C:\\AmiBroker\\Formulas\\CSV_Tickers\\PO-BTC_ETH-5m.csv");
	Import("C:\\AmiBroker\\Formulas\\CSV_Tickers\\PO-BTC_EXP-5m.csv");
	Import("C:\\AmiBroker\\Formulas\\CSV_Tickers\\PO-BTC_FCT-5m.csv");
	Import("C:\\AmiBroker\\Formulas\\CSV_Tickers\\PO-BTC_LSK-5m.csv");
	Import("C:\\AmiBroker\\Formulas\\CSV_Tickers\\PO-BTC_MAID-5m.csv");
	Import("C:\\AmiBroker\\Formulas\\CSV_Tickers\\PO-BTC_NXT-5m.csv");
	Import("C:\\AmiBroker\\Formulas\\CSV_Tickers\\PO-BTC_SC-5m.csv");
	Import("C:\\AmiBroker\\Formulas\\CSV_Tickers\\PO-BTC_STEEM-5m.csv");
	Import("C:\\AmiBroker\\Formulas\\CSV_Tickers\\PO-BTC_XCP-5m.csv");
	Import("C:\\AmiBroker\\Formulas\\CSV_Tickers\\PO-BTC_XEM-5m.csv");
	Import("C:\\AmiBroker\\Formulas\\CSV_Tickers\\PO-BTC_XMR-5m.csv");
	Import("C:\\AmiBroker\\Formulas\\CSV_Tickers\\PO-BTC_XRP-5m.csv");
